...
You are going to use REDIS to perform an analysis on data related to some seller actions.

1. Install REDIS in your workstations. Version 4 of REDIS for windows is available here:
...
2. Download the RECORDED_ACTIONS.zip dataset from https://drive.google.com/open?id=1wyL8nQKDEu6rdr9BH6CgBwGnPnvRT8cJ
3. Do the tasks listed in the “TASKS” section:

**SCENARIO**

You are a data analyst at a consulting firm and you have access to some seller related actions that have been tracked in the previous months. You are asked to create a number of programs/queries for the tasks listed in the “TASKS” section.
